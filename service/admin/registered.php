    ...
    <script src="validation.js"></script>
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" name="phone"class="form-control" placeholder="Phone No" maxlength="10">
        </div>
        <div class="form-group">
          <label for="">Email Id</label>
          <span class="email_error text-danger ml-2">

          </span>
          <input type="email" name="email" class="form-control exif_thumbnail email_id" placeholder="Email Id">
        </div>
        <div class="row">
          <div class="col-md-6">
          <div class="form-group">
