...
<head>
    ...
    <script src="validation1.js"></script>
                    ...
                    <form action="code.php" method="POST" onsubmit="return validateForm1()">
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="phone" value="<?php echo $row['phone']?>" class="form-control" placeholder="Phone No"  maxlength="10">
        </div>
        <div class="form-group">
